...
namespace VendingMachineModels
{
    public class VendingMachineProductDTO
    {
        ...
        public VendingMachineProductDTO(VendingMachineDTO VendingMachineParam, CompartmentDTO CompartmentParam, ProductDTO ProductParam, int CostParam, int StockOnHandParam)
        {
